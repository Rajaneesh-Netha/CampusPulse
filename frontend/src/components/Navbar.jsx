...
export default function Navbar() {
  ...
  const isLoginPage = ['/student/login', '/login'].includes(location.pathname);
    ...
    <nav className="navbar">
      <div className="navbar-container">
        ...
        <div className="navbar-menu">
          ...
          <NavLink to="/student/login" className={({ isActive }) => `nav-link login-link ${isActive ? 'active' : ''}`}>Login</NavLink>
        </div>
      </div>
    </nav>
  );
